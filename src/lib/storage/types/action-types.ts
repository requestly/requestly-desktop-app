...
export enum USER_PREFERENCE {
  ...
  GET_COMPLETE_LOGGING_CONFIG = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:GET_ALL",
  
  GET_IS_LOGGING_ENABLED = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:GET_IS_ENABLED",
  GET_LOCAL_LOG_STORE_PATH = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:STORE_PATH",
  GET_LOG_FILTER = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:GET_FILTER", // returns list of string matched as URL contains
  
  SET_STORE_PATH = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:SET_STORE_PATH",
  SET_FILTER = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:SET_FILTER", // sets list of string matched as URL contains
  SET_IS_LOGGING_ENABLED = "USER_PREFERENCE:OFFLINE_LOG_CONFIG:SET_IS_ENABLED",
